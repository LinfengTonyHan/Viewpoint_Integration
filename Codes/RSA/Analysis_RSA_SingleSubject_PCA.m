function [Street_RS, Building_RS, Distance_RS, Direction_RS, Category_RS, GIST_RS] = ...
    Analysis_RSA_SingleSubject_PCA(Subject, ROI, ROI_type, Matrix)
...
elseif strcmp(ROI, 'HPC') || strcmp(ROI, 'lrEVC') || strcmp(ROI, 'lSPL') || strcmp(ROI, 'rSPL') || strcmp(ROI, 'lrSPL')
    ROI_JRD = ROI;
end
...
[~, RSM_JRD, RDM_JRD] = genRDMs_PCA(Subject, 'JRD', ROI_JRD, 't');
...
cd('Behavioral_Matrices'); 
Dis_Mat = load('DistanceMat_ByLoc.mat'); 
cd ..
