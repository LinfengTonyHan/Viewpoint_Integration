function scatterBarPlot2(Data, yBreaks)
...
groupColor = {[255, 69, 64]/255, [0, 185, 69]/255, [76, 87, 216]/255, [68, 68, 68]/255; ...
                            [235, 122, 119]/255, [134, 193, 102]/255, [125, 185, 222]/255, [156, 156, 156]/255};
...
barGap = 0.04;
baselineWidth = 2;
errorBarWidth = 3.4; % Error bar line width
semHatLength = 0.00;
semHatWidth = 1.7;
...
jitterScatter = 0.024; % Move the scatter points a little aside from the midline of the bar
jitterErrorBar = 0.028; % Move the error bar a little aside
